...
datos_PNN<-read.csv("./01_Datos/Datos_Totales_PNN.csv")
head(datos_PNN)
dim(datos_PNN)

#Separar la matriz de variables
data_completo_PNN<-datos_PNN[c(12:38)]
#dar nombres a las filas utilizando el codigo para las estaciones en cada tipo de marea
...
png(filename = "./02_Imagenes/PCA_PNN_COR.png",width = 20, height = 20, units = "cm", res=300, pointsize = 0.1)
...
png(filename = "./02_Imagenes/PCA_PNN01.png",width = 20, height = 30, units = "cm", res=300, pointsize = 0.1)
grid.arrange(arrangeGrob(graf01_PNN),
...
Sector_PNN <- as.factor(datos_PNN$Sector)


PCA_12_Sector_PNN<-factoextra::fviz_pca_ind(data_completo_PNN.pca,
                                             axes = c(1,2),
                                             col.ind = Sector, # color by groups
                                             palette = c("#00AFBB",  "#FC4E07", "grey", "blue", "black","green"),
                                             addEllipses = TRUE, # Concentration ellipses
...
PCA_23_Sector_PNN<-factoextra::fviz_pca_ind(data_completo_PNN.pca,
                                             axes = c(2,3),
                                             col.ind = Sector, # color by groups
                                             palette = c("#00AFBB",  "#FC4E07", "grey", "blue", "black","green"),
                                             addEllipses = TRUE, # Concentration ellipses
...
png(filename = "./02_Imagenes/PCA_PNN02.png",width = 20, height = 30, units = "cm", res=300, pointsize = 0.1)
grid.arrange(arrangeGrob(PCA_12_marea_PNN,PCA_23_marea_PNN, ncol = 2),
             ...
             arrangeGrob(PCA_12_Sector_PNN,PCA_23_Sector_PNN, ncol = 2),
             ncol=1)
dev.off()
