#Titulo: Visualizaci贸n y An谩lisis descriptivo - CCCP
#Autor: Christian Berm煤dez-Rivas
#Objectivo: Visualizaci贸n y an谩lisis descriptivo de los datos f韘icos obtenidos de la sonda CDT-O General Oceanics 19v PLUS.
#Lenguaje de programaci贸n: R
#Fecha: December 2021
#Notas: 
###############################################################################################################################
...
#Este script tiene c贸mo objetivo realizar las gr谩ficas del componente f韘ico de la Expedici贸n Pac韋ico.
...
Temperatura_Total_CCCP<-ggplot(Datos_CTDO_CCCP, aes(x=Transecto, y=Temperatura)) + 
  geom_boxplot()+ 
  labs( y = "Temperatura [癈]", x = "Transectos")+
...
Temperatura_Hist_CCCP<-ggplot(Datos_CTDO_CCCP, aes(x=Temperatura)) + 
  ...
  labs(title = "Histograma de la Temperatura [癈]",
...
Temperatura_boxplot_CCCP<-ggplot(Datos_CTDO_CCCP) + 
  ...
  theme_bw()+
  labs(title = "Boxplot de la Temperatura [癈]",
       y = "Temperatura [癈]", x = "Estaciones")+
  facet_grid(Marea~Transecto)
...
Temp_A06A_CCCP<-Estandar_15(A06A_CCCP, "A06 - Marea Alta", A06A_CCCP$Temperatura, A06A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_A06B_CCCP<-Estandar_15(A06B_CCCP, "A06 - Marea Baja", A06B_CCCP$Temperatura, A06B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_A05A_CCCP<-Estandar_15(A05A_CCCP, "A05 - Marea Alta", A05A_CCCP$Temperatura, A05A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_A05B_CCCP<-Estandar_15(A05B_CCCP, "A05 - Marea Baja", A05B_CCCP$Temperatura, A05B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_A04A_CCCP<-Estandar_15(A04A_CCCP, "A04 - Marea Alta", A04A_CCCP$Temperatura, A04A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_A04B_CCCP<-Estandar_15(A04B_CCCP, "A04 - Marea Baja", A04B_CCCP$Temperatura, A04B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_A03A_CCCP<-Estandar_40(A03A_CCCP, "A03 - Marea Alta", A03A_CCCP$Temperatura, A03A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_A03B_CCCP<-Estandar_40(A03B_CCCP, "A03 - Marea Baja", A03B_CCCP$Temperatura, A03B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_A02A_CCCP<-Estandar_75(A02A_CCCP, "A02 - Marea Alta", A02A_CCCP$Temperatura, A02A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_A02B_CCCP<-Estandar_75(A02B_CCCP, "A02 - Marea Baja", A02B_CCCP$Temperatura, A02B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_A01A_CCCP<-Estandar_75(A01A_CCCP, "A01 - Marea Alta", A01A_CCCP$Temperatura, A01A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_A01B_CCCP<-Estandar_75(A01B_CCCP, "A01 - Marea Baja", A01B_CCCP$Temperatura, A01B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
...
Oxi_A06A_CCCP<-Estandar_15(A06A_CCCP, "A06 - Marea Alta", A06A_CCCP$Oxigeno, A06A_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
Oxi_A06B_CCCP<-Estandar_15(A06B_CCCP, "A06 - Marea Baja", A06B_CCCP$Oxigeno, A06B_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
Oxi_A05A_CCCP<-Estandar_15(A05A_CCCP, "A05 - Marea Alta", A05A_CCCP$Oxigeno, A05A_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
Oxi_A05B_CCCP<-Estandar_15(A05B_CCCP, "A05 - Marea Baja", A05B_CCCP$Oxigeno, A05B_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
Oxi_A04A_CCCP<-Estandar_15(A04A_CCCP, "A04 - Marea Alta", A04A_CCCP$Oxigeno, A04A_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
Oxi_A04B_CCCP<-Estandar_15(A04B_CCCP, "A04 - Marea Baja", A04B_CCCP$Oxigeno, A04B_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
Oxi_A03A_CCCP<-Estandar_40(A03A_CCCP, "A03 - Marea Alta", A03A_CCCP$Oxigeno, A03A_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
Oxi_A03B_CCCP<-Estandar_40(A03B_CCCP, "A03 - Marea Baja", A03B_CCCP$Oxigeno, A03B_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
Oxi_A02A_CCCP<-Estandar_75(A02A_CCCP, "A02 - Marea Alta", A02A_CCCP$Oxigeno, A02A_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
Oxi_A02B_CCCP<-Estandar_75(A02B_CCCP, "A02 - Marea Baja", A02B_CCCP$Oxigeno, A02B_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
Oxi_A01A_CCCP<-Estandar_75(A01A_CCCP, "A01 - Marea Alta", A01A_CCCP$Oxigeno, A01A_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
Oxi_A01B_CCCP<-Estandar_75(A01B_CCCP, "A01 - Marea Baja", A01B_CCCP$Oxigeno, A01B_CCCP$Profundidad, "Ox韌eno - [mg/L]", "Profundidad [m]")
...
Temp_S06A_CCCP<-Estandar_15(S06A_CCCP, "S06 - Marea Alta", S06A_CCCP$Temperatura, S06A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_S06B_CCCP<-Estandar_15(S06B_CCCP, "S06 - Marea Baja", S06B_CCCP$Temperatura, S06B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_S05A_CCCP<-Estandar_15(S05A_CCCP, "S05 - Marea Alta", S05A_CCCP$Temperatura, S05A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_S05B_CCCP<-Estandar_15(S05B_CCCP, "S05 - Marea Baja", S05B_CCCP$Temperatura, S05B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_S04A_CCCP<-Estandar_15(S04A_CCCP, "S04 - Marea Alta", S04A_CCCP$Temperatura, S04A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_S04B_CCCP<-Estandar_15(S04B_CCCP, "S04 - Marea Baja", S04B_CCCP$Temperatura, S04B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_S03A_CCCP<-Estandar_40(S03A_CCCP, "S03 - Marea Alta", S03A_CCCP$Temperatura, S03A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_S03B_CCCP<-Estandar_40(S03B_CCCP, "S03 - Marea Baja", S03B_CCCP$Temperatura, S03B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_S02A_CCCP<-Estandar_75(S02A_CCCP, "S02 - Marea Alta", S02A_CCCP$Temperatura, S02A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_S02B_CCCP<-Estandar_75(S02B_CCCP, "S02 - Marea Baja", S02B_CCCP$Temperatura, S02B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_S01A_CCCP<-Estandar_75(S01A_CCCP, "S01 - Marea Alta", S01A_CCCP$Temperatura, S01A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_S01B_CCCP<-Estandar_75(S01B_CCCP, "S01 - Marea Baja", S01B_CCCP$Temperatura, S01B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
...
Temp_G06A_CCCP<-Estandar_15(G06A_CCCP, "G06 - Marea Alta", G06A_CCCP$Temperatura, G06A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_G06B_CCCP<-Estandar_15(G06B_CCCP, "G06 - Marea Baja", G06B_CCCP$Temperatura, G06B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_G05A_CCCP<-Estandar_15(G05A_CCCP, "G05 - Marea Alta", G05A_CCCP$Temperatura, G05A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_G05B_CCCP<-Estandar_15(G05B_CCCP, "G05 - Marea Baja", G05B_CCCP$Temperatura, G05B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_G04A_CCCP<-Estandar_15(G04A_CCCP, "G04 - Marea Alta", G04A_CCCP$Temperatura, G04A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_G04B_CCCP<-Estandar_15(G04B_CCCP, "G04 - Marea Baja", G04B_CCCP$Temperatura, G04B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_G03A_CCCP<-Estandar_40(G03A_CCCP, "G03 - Marea Alta", G03A_CCCP$Temperatura, G03A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_G03B_CCCP<-Estandar_40(G03B_CCCP, "G03 - Marea Baja", G03B_CCCP$Temperatura, G03B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_G02A_CCCP<-Estandar_75(G02A_CCCP, "G02 - Marea Alta", G02A_CCCP$Temperatura, G02A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_G02B_CCCP<-Estandar_75(G02B_CCCP, "G02 - Marea Baja", G02B_CCCP$Temperatura, G02B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_G01A_CCCP<-Estandar_75(G01A_CCCP, "G01 - Marea Alta", G01A_CCCP$Temperatura, G01A_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
Temp_G01B_CCCP<-Estandar_75(G01B_CCCP, "G01 - Marea Baja", G01B_CCCP$Temperatura, G01B_CCCP$Profundidad, "Temperatura - [癈]", "Profundidad [m]")
...
hexbin_Temp_CCCP<-hexbin_plot(Datos_CTDO_CCCP, Datos_CTDO_CCCP$Temperatura, Datos_CTDO_CCCP$Profundidad, "Temperatura [癈]", "Profundidad [m]")
...
hexbin_Oxi_CCCP<-hexbin_plot(Datos_CTDO_CCCP, Datos_CTDO_CCCP$Oxigeno, Datos_CTDO_CCCP$Profundidad, "Ox韌eno [mg/L]", "Profundidad [m]")
...
hexbin_Oxi_Temp<-hexbin_plot(Datos_CTDO_CCCP, Datos_CTDO_CCCP$Oxigeno, Datos_CTDO_CCCP$Temperatura, "Ox韌eno [mg/L]", "Temperatura [癈]")
