...
MRPP_Transecto_Abundancia<-vegan::mrpp(dat = Abundancia_Relativa_distmat,  Codigo_fito_abundancia$Transecto, permutations = 2000, distance = "bray")
MRPP_Marea_Abundancia<-vegan::mrpp(dat = Abundancia_Relativa_distmat,  Codigo_fito_abundancia$Marea, permutations = 2000, distance = "bray")
MRPP_Sector_Abundancia<-vegan::mrpp(dat = Abundancia_Relativa_distmat,  Codigo_fito_abundancia$Sector, permutations = 2000, distance = "bray")
...
coordenadas$Estaciones<-Codigo_fito_abundancia$Estaciones
